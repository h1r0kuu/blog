            ...
            <Box sx={Styles.MainContentBox}>
                <Box sx={Styles.PostInfoBox}>
                    ...
                    <Box sx={Styles.PostDescription}>
                        ...
                        <Typography color="rgb(126, 126, 132)" variant="body2">{formatDistanceToNow(new Date(post?.createdAt || Date.now()))} ago</Typography>                    </Box>
                </Box>
                <Card sx={Styles.PostBodyBox}>
                    <CardContent>
                        <Typography variant="body1" dangerouslySetInnerHTML={{ __html: post?.body || '' }} />                        <Card sx={Styles.PostRatingBox}>
                        <CardContent sx={Styles.PostRatingBoxContent}>
                            ...
                            <Box sx={Styles.SecondIconsGroup}>
                                {isAuthenticated() && user.username === post?.creator.username && (
                                    <>
                                        <Button onClick={handleDeleteClick} variant="outlined" color="error" startIcon={<DeleteOutlineOutlinedIcon />}>
                                            DELETE
                                        </Button>
                                        <Button onClick={handleEditClick} variant="outlined" color="info" startIcon={<EditNoteOutlinedIcon />}>
                                            EDIT
                                        </Button>
                                    </>
                                )}
